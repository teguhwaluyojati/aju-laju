...
const highlights = [
  {
    title: "Catat Lebih Mudah",
    description: "Input data servis dan bensin dalam hitungan detik dengan form yang simpel.",
    icon: <path d="M12 8v4l3 2M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />,
  },
  {
    title: "Dashboard Visual",
    description: "Lihat ringkasan pengeluaran dalam grafik yang enak dibaca setiap saat.",
    icon: <path d="M3 3v18h18M8 17V9m5 8v-5m5 5V6" />,
  },
  {
    title: "Data Aman",
    description: "Tersimpan di cloud Firebase, bisa diakses dari device mana saja.",
      ...
      <main className="container-app pb-20 pt-6">
        ...
        <section className="mx-auto max-w-3xl animate-fade-in text-center">
          ...
          <h1 className="mt-5 font-display text-4xl leading-tight text-ink sm:text-5xl">
            Kenapa <span className="text-brand-600">AjuLaju</span>?
          </h1>
          <p className="mx-auto mt-5 max-w-xl text-base text-ink-muted sm:text-lg">
            AjuLaju hadir untuk membantu pemilik kendaraan mencatat pengeluaran servis dan bensin
            secara digital — lebih rapi, cepat, dan bisa dipantau kapan saja.
          </p>
        </section>
        ...
        <section className="mx-auto mt-20 max-w-2xl text-center">
          <h2 className="font-display text-2xl text-ink">Dibangun dengan Teknologi Modern</h2>
          <p className="mt-2 text-sm text-ink-muted">
            Performa cepat, UI responsif, dan pengalaman pengguna yang lancar.
          </p>
        ...
        <section className="mx-auto mt-20 max-w-xl">
          <div className="rounded-2xl border border-surface-border bg-gradient-to-br from-white to-surface-muted p-6 text-center shadow-card sm:p-8">
            ...
            <p className="mt-4 text-sm leading-relaxed text-ink-muted">
              Fullstack developer yang passionate membangun produk digital bermanfaat.
              AjuLaju adalah salah satu project pribadi untuk membantu pencatatan kendaraan sehari-hari.
            </p>
